...
public class SubscriptionPlanActivity_old extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subscription_plan_activity_old);
     ...
     premium=(RelativeLayout)findViewById(R.id.premium_relative_id);
        ...
        classic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SubscriptionPlanActivity_old.this, DetailsActivity.class);
